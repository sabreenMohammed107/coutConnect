<div class="card-header align-items-center py-5 gap-2 gap-md-5">
    ...
    <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            ...
            <div class=" col-md-2 text-left w-100 ">
                <button class="btn  form-control form-control-solid w-250px ps-14 btn-primary" id="exporttable">Export To Excel <i
                    class="fas fa-file-export"></i></button> </div>
        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_category_table">
            ...
            <thead>
                ...
                <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                    ...
                    <th class="text-end min-w-70px hide-data">Activation</th>
...
style="background-image:url({{ asset('uploads/doctors') }}/{{ $row->img }});"></span>
                        ...
                        <td class="text-end pe-0" data-order="15">
                            <span class="fw-bolder ms-3">{{ $row->registerType->status ?? '' }}</span>
                        </td>
                        <!--end::Qty=-->
                        <!--begin::Qty=-->
                        <td class="text-end pe-0" data-order="15">
                        ...
                        <td class="text-end pe-0 hide-data" data-order="15">
                            <span class="fw-bolder ms-3">
                                {{ $row->verified == 1 ? ' Active' : 'Not Active' }}</span>
                        </td>
                        <!--end::Qty=-->
                        <!--begin::Action=-->
                        <td class="text-end hide-data">
                            ...
                            @if ($row->verified != 1)
                                <button title="verify" class="btn btn-icon btn-active-light-primary w-30px h-30px me-3"
                            ...
                            <a class="btn btn-icon btn-active-light-primary w-30px h-30px" href="#"
                                ...
                                <form id="delete_{{ $row->id }}" action="{{ route('doctors.destroy', $row->id) }}"
