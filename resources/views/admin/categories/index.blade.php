                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a href="#">
                                                <div class="symbol-label fs-3 bg-light-danger text-danger">
                                                    <img src="{{ asset('uploads/categories') }}/{{ $row->category_img }}"
                                                        class="w-100" alt="">
                                                </div>
                                            </a>
                                        </div>
...
<input type="hidden" name="" id=""  data-kt-ecommerce-category-filter="category_id" value="{{$row->id}}" >
									...
									<form id="delete_{{$row->id}}" action="{{ route('categories.destroy', $row) }}"  method="POST" style="display: none;">
									@csrf
									@method('DELETE')
                                                    ...
                                                    <form id="kt_modal_update_target_updateForm" class="form"
                                                        ...
                                                        <div class="mb-7">
                                                            ...
                                                            <div class="mt-1">
                                                                ...
                                                                <div class="image-input image-input-outline"
                                                                    ...
                                                                    style="background-image: url(' {{ asset('uploads/categories') }}/{{ $row->category_img }}')">
                                                        ...
                                                        <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                ...
                                                                <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                    data-bs-toggle="tooltip" title="Enter Category Name"></i>
                                                            </label>
                                                            <!--end::Label-->
                                                            <input type="text" class="form-control form-control-solid"
                                                                placeholder="Enter Category Name" name="category_enname" value="{{$row->category_enname}}" />
                                                        </div>
                                                        <!--end::Input group-->

                                                        <!--begin::Input group-->
                                                        <div class="d-flex flex-column mb-8">
                                                            <label class="fs-6 fw-bold mb-2">Category Overview</label>
                                                            <textarea class="form-control form-control-solid" rows="3" name="category_overview"
                                                        ...
                                                        {{-- <div class="d-flex flex-column mb-8 fv-row">
                                                            ...
                                                            <label class="d-flex align-items-center fs-6 fw-bold mb-2">
                                                                ...
                                                                <i class="fas fa-exclamation-circle ms-2 fs-7"
                                                                    data-bs-toggle="tooltip"
                                                                    title="Specify Category Order"></i>
                                                            </label>
                                                            <!--end::Label-->
    ...
    <div class="modal fade" id="kt_modal_new_target" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content rounded">
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    <!--begin:Form-->
                    <form id="kt_modal_new_target_form" class="form" action="{{ route('categories.store') }}"
                        method="post" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Heading-->
                        <div class="mb-13 text-center">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3"
                                    ...
                                    <label
                                        ...
                                        <i class="bi bi-pencil-fill fs-7"></i>
                                        <!--begin::Inputs-->
                                        <input type="file" name="category_img" accept=".png, .jpg, .jpeg" />
                                        <input type="hidden" name="avatar_remove" />
                                        <!--end::Inputs-->
                                    </label>
                                    <!--end::Label-->
