    ...
    <div class="toolbar" id="kt_toolbar">
        <div class="container-fluid d-flex flex-stack flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex flex-column align-items-start justify-content-center flex-wrap me-2">
                <!--begin::Title-->
                <h1 class="text-dark fw-bolder my-1 fs-2">vodafone-cash</h1>
                <!--end::Title-->
                <!--begin::Breadcrumb-->
                <ul class="breadcrumb fw-bold fs-base my-1">
                    ...
                    <li class="breadcrumb-item text-muted">vodafone-cash</li>
    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
                    ...
                    <div class="card-body pt-0">
                        <div class="d-flex flex-wrap gap-5">
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <!--end::Label-->
                                <select disabled class="form-select form-select-solid" id="payment_id" name="payment_id"
                                    data-control="select2" data-placeholder="Select an option">
                                    <option value=""></option>
                                    @foreach ($payments as $obj)
                                        <option value="{{ $obj->id }}" {{ $obj->id == 1 ? 'selected' : '' }} >{{ $obj->payment_method }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="fv-row w-100 flex-md-root">
            ...
            <div id="preIndex" class="card card-flush">
                <!--begin::Card header-->
                @include('admin.vodafone-cash.preIndex')
...
<script>
     $('#search-form').on('submit', function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('vodafone-cash-filter') }}",
