                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <input type="text" name="name" value="{{ $event->name }}"
                                                class="form-control mb-2" placeholder="Event name" value="" />
                                        ...
                                        <div class="d-flex flex-wrap gap-5">
                                            ...
                                            <div class="fv-row w-100 flex-md-root">
                                                ...
                                                <!--begin::Input-->
                                                <!--begin::Select2-->
                                                <select class="form-select form-select-solid" name="event_status_id"
                                                    data-control="select2" data-placeholder="Select an option">
                                                    <option></option>
                                                    @foreach ($status as $type)
                                                        <option value="{{ $type->id }}"
                                                            {{ $event->event_status_id == $type->id ? 'selected' : '' }}>
                                                            {{ $type->status }}</option>
                                                    @endforeach
                                    ...
                                    <!--end::Editor-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input type="text" value="{{ $event->details_address }}"
                                                    name="details_address" class="form-control mb-2"
                                                    placeholder="Event name" value="" />
                                                                        ...
                                                                        <div class="accordion-item">
                                                                            <h2 class="accordion-header"
                                                                                ...
                                                                                <button
                                                                                    ...
                                                                                    Instructor {{ $eventInstructor->name }}
                                                                                </button>
                                                                            </h2>
                                                        ...
                                                        <td>
                                                            @if ($faq->active != 1)
                                                                    ...
                                                                    <input type="hidden" name="event_id" id=""
                                                                        value="{{ $faq->event_id }}">
                                                                        <input type="hidden" value="{{$faq->event_id}}" name="activeFaq" >
                                                            ...
                                                            @if ($faq->active == 1)
                                                                    ...
                                                                    <input type="hidden" name="event_id" id=""
                                                                        value="{{ $faq->event_id }}">
                                                                        <input type="hidden" value="{{$faq->event_id}}" name="deActiveFaq" >
                                                                    <a onclick="$(this).closest('form').submit()">
                                                                        <span class="svg-icon svg-icon-3">
