    ...
    <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
        ...
        <div class="container-xxl">
            <form id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row "
                action="{{ route('savingCopoun') }}" method="post" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                <div class="fv-row w-100 flex-md-root mt-10">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" checked name="radio_input" type="radio" value="1"
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" name="radio_input" type="radio" value="2"
                                ...
                                <div class="fv-row w-100 flex-md-root mt-10">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" id="email" name="nValue"
                                        class="form-control mb-2 @error('nValue') is-invalid @enderror" value="{{ old('nValue') }}"
                            ...
                            <div class="d-flex flex-wrap gap-5">
                                <div class="fv-row w-100 flex-md-root mt-10">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" name="coat_input" checked type="radio" value="1"
                                        id="kt_docs_formvalidation_radio_option_1" />
                                    <!--end::Input-->
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-check-input me-3" name="coat_input" type="radio" value="2"
                                        id="kt_docs_formvalidation_radio_option_2" />
                                    <!--end::Input-->
                                ...
                                <div class="fv-row w-100 flex-md-root mt-10">
                                    ...
                                    <input type="number" id="email" name="CValue"
                                        class="form-control mb-2 @error('CValue') is-invalid @enderror" value="{{ old('CValue') }}"
                            ...
                            <div class="fv-row w-100 flex-md-root">
                                ...
                                <input type="number" id="email" name="coupons_quantity"
                                    class="form-control mb-2 @error('coupons_quantity') is-invalid @enderror" value="{{ old('coupons_quantity') }}"
                        ...
                        <div class="d-flex flex-wrap gap-5">
                            <div class="fv-row w-100 flex-md-root">
                                <label class="form-label">Valid
                                    From:</label>
                                <input class="form-control  form-control-solid dPick" name="valid_from" value=""
                                    placeholder="Pick date" id="kt_datepicker_3" />
                            </div>
                            <div class="fv-row w-100 flex-md-root">
                                <label class="form-label">Valid
                                    To:</label>
                                <input class="form-control  form-control-solid dPick" name="valid_to" value=""
                                    placeholder="Pick date" id="kt_datepicker_4" />
                            </div>
                        </div>
                    </div>
